...
import com.caloriesnap.data.local.dao.FoodRecordDao_Impl;
import com.caloriesnap.data.local.dao.RecentFoodDao;
import com.caloriesnap.data.local.dao.RecentFoodDao_Impl;
import com.caloriesnap.data.local.dao.WeightRecordDao;
import com.caloriesnap.data.local.dao.WeightRecordDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsFoodRecords = new HashMap<String, TableInfo.Column>(10);
        _columnsFoodRecords.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFoodRecords.put("date", new TableInfo.Column("date", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsFoodRecords.put("weight", new TableInfo.Column("weight", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFoodRecords.put("calories", new TableInfo.Column("calories", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsFoodRecords.put("imageUri", new TableInfo.Column("imageUri", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoFoodRecords.equals(_existingFoodRecords)) {
          return new RoomOpenHelper.ValidationResult(false, "food_records(com.caloriesnap.data.local.entity.FoodRecordEntity).\n"
                  + " Expected:\n" + _infoFoodRecords + "\n"
                  + " Found:\n" + _existingFoodRecords);
        }
        final HashMap<String, TableInfo.Column> _columnsWeightRecords = new HashMap<String, TableInfo.Column>(3);
        _columnsWeightRecords.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsWeightRecords.put("date", new TableInfo.Column("date", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoWeightRecords.equals(_existingWeightRecords)) {
          return new RoomOpenHelper.ValidationResult(false, "weight_records(com.caloriesnap.data.local.entity.WeightRecordEntity).\n"
                  + " Expected:\n" + _infoWeightRecords + "\n"
        ...
        if (!_infoFoods.equals(_existingFoods)) {
          return new RoomOpenHelper.ValidationResult(false, "foods(com.caloriesnap.data.local.entity.FoodEntity).\n"
                  + " Expected:\n" + _infoFoods + "\n"
                  + " Found:\n" + _existingFoods);
        }
        final HashMap<String, TableInfo.Column> _columnsRecentFoods = new HashMap<String, TableInfo.Column>(2);
        _columnsRecentFoods.put("foodId", new TableInfo.Column("foodId", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsRecentFoods.put("usedAt", new TableInfo.Column("usedAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysRecentFoods = new HashSet<TableInfo.ForeignKey>(0);
        final HashSet<TableInfo.Index> _indicesRecentFoods = new HashSet<TableInfo.Index>(0);
        final TableInfo _infoRecentFoods = new TableInfo("recent_foods", _columnsRecentFoods, _foreignKeysRecentFoods, _indicesRecentFoods);
        final TableInfo _existingRecentFoods = TableInfo.read(db, "recent_foods");
        if (!_infoRecentFoods.equals(_existingRecentFoods)) {
          return new RoomOpenHelper.ValidationResult(false, "recent_foods(com.caloriesnap.data.local.entity.RecentFoodEntity).\n"
                  + " Expected:\n" + _infoRecentFoods + "\n"
  ...
  @Override
  public RecentFoodDao recentFoodDao() {
    if (_recentFoodDao != null) {
